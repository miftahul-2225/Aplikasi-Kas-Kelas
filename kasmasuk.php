...
<div class="d-flex">
    ...
    <aside class="bg-white border-end p-3 d-flex flex-column position-sticky top-0 vh-100" style="width:230px;">
        ...
        <ul class="nav nav-pills flex-column gap-2 mb-auto">
            ...
            <li class="nav-item">
                <a href="kasmasuk.php" class="nav-link active d-flex align-items-center gap-3 fs-5">
    ...
    <main class="flex-fill p-4">
        ...
        <!-- HEADER -->
        <div class="mb-4">
            <h2 class="fw-semibold">Kas Masuk</h2>
            <p class="text-muted mb-0">Daftar transaksi kas masuk</p>
        </div>

        <!-- CONTENT -->
        <!-- TOTAL KAS -->
        <div class="card border-success bg-success-subtle shadow-sm mb-4 rounded-4">
        <div class="card-body d-flex justify-content-between align-items-center">

        <div>
            <h2 class="text-success fw-semibold">
        ...
        <div class="bg-success text-white d-flex align-items-center justify-content-center rounded-4"
...
<div class="card shadow-sm rounded-4">
    <div class="card-body p-4">
        <h5 class="fw-semibold mb-4">Riwayat Kas Masuk</h5>
            ...
            <div class="card border-0 shadow-sm mb-3 rounded-4">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                        <h6 class="mb-1">
                            Iuran kas - <?= $row['nama_siswa'] ?? 'Umum' ?>
                        </h6>

                        <span class="badge bg-primary-subtle text-primary">
                            <?= $row['keterangan'] ?? 'Iuran' ?>
                        </span>
