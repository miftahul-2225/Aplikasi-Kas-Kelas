...
<div id="sidebar">
    ...
    <nav class="sb-nav">
        ...
        <div class="nav-item mt-2">
            <a href="kasmasuk.php" class="nav-link active" data-tip="Kas Masuk">
...
<main id="main">
    ...
    <!-- HEADER -->
    <div class="mb-4">
        <h4 class="fw-bold mb-1">Kas Masuk</h4>
        <p class="text-muted small mb-0">Daftar transaksi kas masuk</p>
    </div>
    ...
    <div class="card border rounded-4">
        <div class="card-body p-4">
            ...
            <p class="text-muted text-center py-3">
                <i class="fa-solid fa-circle-info me-2"></i>Belum ada transaksi kas masuk.
            </p>
            <?php endif; ?>
            ...
            <div class="card border rounded-4 mb-2">
                <div class="card-body d-flex justify-content-between align-items-center gap-3 py-3">
                    ...
                    <span class="fw-bold text-success small text-nowrap">
