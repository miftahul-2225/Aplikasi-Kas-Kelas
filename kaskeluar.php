...
<head>
    ...
    <style>
        ...
        .sb-toggle {
            ...
            background: #fff; border: 1px solid #dde2ee; border-radius: 50%;
            display: flex; align-items: center; justify-content: center;
...
<div id="sidebar">
    ...
    <nav class="sb-nav">
        ...
        <div class="nav-item">
            <a href="kaskeluar.php" class="nav-link active" data-tip="Kas Keluar">
        ...
        <div class="card-body d-flex justify-content-between align-items-center p-4">
            <div>
                ...
                <small class="text-white opacity-75">
                    <?= $totalTransaksi ?> transaksi pengeluaran
                </small>
            </div>
    ...
    <div class="card border rounded-4">
        <div class="card-body p-4">
            ...
            <p class="text-muted text-center py-3">
                <i class="fa-solid fa-circle-info me-2"></i>Belum ada transaksi kas keluar.
            </p>
            <?php endif; ?>
            ...
            <div class="card border rounded-4 mb-2">
                <div class="card-body d-flex justify-content-between align-items-center gap-3 py-3">
                        ...
                        <div>
                            ...
                            <div class="d-flex align-items-center gap-2 flex-wrap">
                                <span class="badge bg-danger bg-opacity-10 text-danger" style="font-size:11px;">
                                    <?= htmlspecialchars($row['keterangan'] ?? 'Pengeluaran') ?>
                                </span>
                    ...
                    <span class="fw-bold text-danger small text-nowrap">
