                ...
                <div class="table-responsive">
                    <table class="table table-hover text-center mb-0">
                        ...
                        <tbody>
                            ...
                            <?php if ($total == 0) : ?>
                                <tr>
                                    <td colspan="6" class="py-4 text-muted"><i class="fa-solid fa-circle-info me-2"></i>Tidak ada data murid<?= $cari ? ' dengan kata kunci "' . htmlspecialchars($cari) . '"' : '' ?></td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
            ...
            <div class="modal-content rounded-4 border-0">
                ...
                <form method="POST" action="proses_transaksi.php">
                    <div class="modal-body">
                        <div class="mb-3"><label class="form-label">Jenis</label><select name="jenis" class="form-select rounded-3" required>
